...
var terraformPluginSDKExternalNameConfigs = map[string]config.ExternalName{
	...
	// Can be imported using the following format: {{ role_id }}:{{ team_slug }}
	"github_organization_role_team": config.IdentifierFromProvider,
	// Deprecated: Use github_organization_role_team instead.
	// Can be imported using the following format: {{ team_slug }}:{{ role_id }}
	"github_organization_role_team_assignment": config.IdentifierFromProvider,
