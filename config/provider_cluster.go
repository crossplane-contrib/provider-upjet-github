...
import (
	...
	"github.com/crossplane-contrib/provider-upjet-github/config/cluster/dependabotorganizationsecret"
	"github.com/crossplane-contrib/provider-upjet-github/config/cluster/dependabotsecret"
