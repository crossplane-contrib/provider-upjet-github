...
type EnvironmentDeploymentPolicyInitParameters struct {
	...
	// The name of the environment.
	// +crossplane:generate:reference:type=github.com/crossplane-contrib/provider-upjet-github/apis/namespaced/repo/v1alpha1.Environment
...
type EnvironmentDeploymentPolicyObservation struct {
	...
	// The ID of the deployment policy.
	PolicyID *int64 `json:"policyId,omitempty" tf:"policy_id,omitempty"`
