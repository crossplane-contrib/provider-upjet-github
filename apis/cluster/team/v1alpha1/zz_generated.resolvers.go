...
func (mg *EmuGroupMapping) ResolveReferences( // ResolveReferences of this EmuGroupMapping.
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("team.github.upbound.io", "v1alpha1", "Team", "TeamList")
		if err != nil {
...
func (mg *TeamRepository) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	var err error
	{
		m, l, err = apisresolver.GetManagedResource("repo.github.upbound.io", "v1alpha1", "Repository", "RepositoryList")
		if err != nil {
			return errors.Wrap(err, "failed to get the reference target managed resource and its list for reference resolution")
		}
