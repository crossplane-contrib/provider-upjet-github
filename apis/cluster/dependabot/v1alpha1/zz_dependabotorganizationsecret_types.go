...
type DependabotOrganizationSecretInitParameters struct {
...
type DependabotOrganizationSecretObservation struct {
...
type DependabotOrganizationSecretParameters struct {
...
// DependabotOrganizationSecretSpec defines the desired state of DependabotOrganizationSecret
type DependabotOrganizationSecretSpec struct {
	v1.ResourceSpec `json:",inline"`
	ForProvider     DependabotOrganizationSecretParameters `json:"forProvider"`
	...
	// autoscaler.
	InitProvider DependabotOrganizationSecretInitParameters `json:"initProvider,omitempty"`
}

// DependabotOrganizationSecretStatus defines the observed state of DependabotOrganizationSecret.
type DependabotOrganizationSecretStatus struct {
	v1.ResourceStatus `json:",inline"`
	AtProvider        DependabotOrganizationSecretObservation `json:"atProvider,omitempty"`
}
...
// DependabotOrganizationSecret is the Schema for the DependabotOrganizationSecrets API. Creates and manages an Dependabot Secret within a GitHub organization
...
type DependabotOrganizationSecret struct {
	...
	Spec   DependabotOrganizationSecretSpec   `json:"spec"`
	Status DependabotOrganizationSecretStatus `json:"status,omitempty"`
}

// +kubebuilder:object:root=true

// DependabotOrganizationSecretList contains a list of DependabotOrganizationSecrets
type DependabotOrganizationSecretList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DependabotOrganizationSecret `json:"items"`
}

// Repository type metadata.
var (
	DependabotOrganizationSecret_Kind             = "DependabotOrganizationSecret"
	DependabotOrganizationSecret_GroupKind        = schema.GroupKind{Group: CRDGroup, Kind: DependabotOrganizationSecret_Kind}.String()
	DependabotOrganizationSecret_KindAPIVersion   = DependabotOrganizationSecret_Kind + "." + CRDGroupVersion.String()
	DependabotOrganizationSecret_GroupVersionKind = CRDGroupVersion.WithKind(DependabotOrganizationSecret_Kind)
)

func init() {
	SchemeBuilder.Register(&DependabotOrganizationSecret{}, &DependabotOrganizationSecretList{})
}
