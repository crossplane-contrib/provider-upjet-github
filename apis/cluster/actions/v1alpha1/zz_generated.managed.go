...
// GetCondition of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) GetCondition(ct xpv1.ConditionType) xpv1.Condition {
	return mg.Status.GetCondition(ct)
}

// GetDeletionPolicy of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) GetDeletionPolicy() xpv1.DeletionPolicy {
	return mg.Spec.DeletionPolicy
}

// GetManagementPolicies of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) GetManagementPolicies() xpv1.ManagementPolicies {
	return mg.Spec.ManagementPolicies
}

// GetProviderConfigReference of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) GetProviderConfigReference() *xpv1.Reference {
	return mg.Spec.ProviderConfigReference
}

// GetWriteConnectionSecretToReference of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) GetWriteConnectionSecretToReference() *xpv1.SecretReference {
	return mg.Spec.WriteConnectionSecretToReference
}

// SetConditions of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) SetConditions(c ...xpv1.Condition) {
	mg.Status.SetConditions(c...)
}

// SetDeletionPolicy of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) SetDeletionPolicy(r xpv1.DeletionPolicy) {
	mg.Spec.DeletionPolicy = r
}

// SetManagementPolicies of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) SetManagementPolicies(r xpv1.ManagementPolicies) {
	mg.Spec.ManagementPolicies = r
}

// SetProviderConfigReference of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) SetProviderConfigReference(r *xpv1.Reference) {
	mg.Spec.ProviderConfigReference = r
}

// SetWriteConnectionSecretToReference of this ActionsHostedRunner.
func (mg *ActionsHostedRunner) SetWriteConnectionSecretToReference(r *xpv1.SecretReference) {
