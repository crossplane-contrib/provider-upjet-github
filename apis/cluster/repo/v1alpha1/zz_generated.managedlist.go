...
// GetItems of this RepositoryCollaboratorSetList.
func (l *RepositoryCollaboratorSetList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
...
// GetItems of this RepositoryCustomPropertyList.
func (l *RepositoryCustomPropertyList) GetItems() []resource.Managed {
	items := make([]resource.Managed, len(l.Items))
	for i := range l.Items {
		items[i] = &l.Items[i]
	}
