...
| `OrganizationCustomProperties` | `organization` | `github_organization_custom_properties`           |                                                                                                                                                                                                                                                                                                                             |
| `OrganizationRoleTeam`        | `organization` | `github_organization_role_team`                   |                                                                                                                                                                                                                                                                                                                             |
| `OrganizationRoleTeamAssignment` | `organization` | `github_organization_role_team_assignment`      | **Deprecated:** Use `OrganizationRoleTeam` instead. Cluster-scoped only.                                                                                                                                                                                                                                                    |
