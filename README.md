...
| `AppInstallationRepositories` | `app`          | `github_app_installation_repositories`            | Not compatible with GitHub App Installation authentication. Deleting the resource leaves the app installed on one repository because GitHub does not allow an installation with no selected repositories.                                                                                                                   |
