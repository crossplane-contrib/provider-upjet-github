...
| `DependabotSecret`            | `dependabot`   | `github_dependabot_secret`                        |                                                                                                                                                                                                                                                                                                                             |
| `DependabotOrganizationSecret`| `dependabot`   | `github_dependabot_organization_secret`           | The `owner` attribute in the `credentials` JSON structure must point to the organization.                                                                                                                                                                                                                                   |
