...
| `OrganizationPermissions`     | `actions`      | `github_actions_organization_permissions`         | DISABLED due to wrong type association                                                                                                                                                                                                                                                                                      |
...
| `RunnerGroup`                 | `actions`      | `github_actions_runner_group`                     | DISABLED due to wrong type association                                                                                                                                                                                                                                                                                      |
...
| `TeamRepository`              | `team`         | `github_team_repository`                          | DISABLED due to import cycle                                                                                                                                                                                                                                                                                                |
